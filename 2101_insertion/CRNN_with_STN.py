...
from Batch_Generator_2 import img_gen, img_gen_val

from config2 import learning_rate, load_model_path, width, height, characters, label_len, label_classes, \
...
model.fit_generator(img_gen(input_shape=bn_shape), steps_per_epoch=2000, epochs=4, verbose=1,
                    callbacks=[evaluator,
                               checkpoint])
